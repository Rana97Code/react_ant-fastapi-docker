     ...
     <Card className="myServiceCard" bordered={false} >
        ...
        <Form  name="normal_login"  className="login-form"  initialValues={{ remember: true, }}  >
            <Row justify="space-between">
                ...
                <Col>
                  <Select className="inputWi" placeholder="Select Customer " value={customer_id} onChange={(e)=>setCust(e)} optionLabelProp="label"  >
          ...
          <Row justify="space-between">
            ...
            <Col>
                <Input className="inputWi" prefix={<DiffOutlined className="site-form-item-icon" />} 
        ...
        <br></br>
          <Row justify="space-between">
            ...
            <Col>
                <Input className="inputWi" placeholder={expiry_date} disabled />
            </Col>
          </Row>
      ...
      <br />
          ...
          <Row justify="space-between">
              ...
              <Col>
                  <Select  showSearch className="inputWi" value={service_time} onChange={(e)=>setTime(e)} optionLabelProp="label"  >
          ...
          <br />
            ...
            <Row justify="space-between">
              ...
              <Col>
                  <Select showSearch className="inputWi" value={notify_time} onChange={(e)=>setNtime(e)} optionLabelProp="label"  >
                ...
                <Checkbox.Group onChange={(e)=>setNotifTyp(e)} value={notify_type} >
                  ...
                  <Row>
                    <Col span={12} >
                      ...
                      <hr />
                      <Select className="mTitle" showSearch placeholder="SMS Title" value={parseInt(sms_id)} onChange={(e)=>setSmstitl(e)} optionLabelProp="label" >
                  ...
                  <br />
                    ...
                    <Col span={12} >
                      ...
                      <hr />
                      <Select className="mTitle" showSearch placeholder="Email Title" value={parseInt(email_id)} onChange={(e)=>setEmltitl(e)} optionLabelProp="label" >
                        <Option selected ><Space> Select </Space> </Option>
